# This will generate a new random parameterization base on your breeding programs
# this should be involved how many parameters you want to optimize 
# it can be that some of the are not include the cost function so you should adopt your script 
